...
TOKEN = os.getenv("BOT_TOKEN", "8054930534:AAFDdyp5_xiX0ZPQnSEZKpfOhk2PCdchKvg")
CHANNEL_ID = os.getenv("CHANNEL_ID", "@TopPsyGame")
BOT_LINK = os.getenv("BOT_LINK", "t.me/choose_a_card_bot")
TIMEZONE = pytz.timezone("Europe/Moscow")
ADMIN_ID = int(os.getenv("ADMIN_ID", "6682555021"))
