...
def save_user_action(user_id, action, details=None):
    user_actions = load_user_actions()
    username = bot.get_chat(user_id).username if bot.get_chat(user_id).username else ""
...
async def start_command(message: types.Message, state: FSMContext):
    ...
    save_user_action(user_id, "start", {"args": args})
...
async def process_name(message: types.Message, state: FSMContext):
    ...
    save_user_action(user_id, "set_name", {"name": name})
...
async def process_skip_name(callback: types.CallbackQuery, state: FSMContext):
    ...
    save_user_action(user_id, "skip_name")
...
async def process_reminder_time(message: types.Message, state: FSMContext):
    ...
    try:
        ...
        save_user_action(user_id, "set_reminder_time", {"reminder_time": reminder_time_normalized})
...
async def process_feedback_submission(message: types.Message, state: FSMContext):
    ...
    save_user_action(user_id, "submit_feedback", {"feedback": feedback_text})
...
async def process_request_confirmation(callback: types.CallbackQuery, state: FSMContext):
    ...
    try:
        ...
        save_user_action(user_id, "card_request", {"card_number": card_number, "reflection_question": reflection_question})
...
async def handle_bonus_request(message: types.Message, state: FSMContext):
    ...
    save_user_action(user_id, "bonus_request", {"advice": advice})
...
async def process_feedback(callback: types.CallbackQuery):
    ...
    save_user_action(user_id, "card_feedback", {"card_number": card_number, "feedback": feedback})
