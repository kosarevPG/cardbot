...
MARKETPLACE_TEXTS = {
    ...
    "getting_prices": "💰 Получаю актуальные цены товаров...",
    "prices_updated_success": "✅ Цены обновлены успешно!\n🛒 Цены Ozon: {ozon_count}\n🛍️ Цены WB: {wb_count}",
    "prices_update_error": "❌ Ошибка получения цен: {error}",
    "prices_critical_error": "❌ Произошла ошибка при получении цен.",
    ...
    "errors": {
        ...
        "access_denied": "❌ Доступ запрещен. Только для администраторов."
    },
